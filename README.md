...
```
wget https://raw.githubusercontent.com/nashsclay/DAPSCoin_Masternode/master/dapscoin_update_mn3.sh
chmod +x dapscoin_update_mn3.sh
./dapscoin_update_mn3.sh
```
...
Download the newest wallet for your computer here: https://officialdapscoin.com/
...
Next type in the amount of coins you wish to send to your MN (this coin should be 1000000 DAPS. NO more NO less). Once done, click Send
...
## To Install the DAPS-Masternode on VPS Server
...
This will give you access to the folder of DAPSCoin-Masternode files. Notice the period in front of the folder. If your are in the home folder and do **ls** command, it will not show the folder. Period means hidden. Correct command to display this folder in the home folder is **ls -al**

`cd ~/.dapscoin`


You can alway DM me on discord at nashsclay#6809, just mention what coin you need assistance with in the message.
